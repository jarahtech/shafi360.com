<?php
/*
 *  Copyright (C) 2020-2021 Md Shafiqul Islam (Shafi360).
 *
...
// get variable
  ...
  $removeuserprofile = $_GET['remove-user-profile'];
	@$refreshpppuser = $_GET['refresh-hotspot-user'];
...
elseif ($refreshpppuser != ""){
  include_once('./hotspot/refresh.php');
  die();
}
// hotspot add users
...
<script src="./js/mahabub-ui.<?= $theme; ?>.min.js"></script>
<script src="./js/mahabub.js?t=<?= str_replace(" ","_",date("Y-m-d H:i:s")); ?>"></script>

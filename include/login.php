  ...
  <div class="card">
    ...
    <div class="card-body">
      <div class="text-center pd-5">
        <img src="img/favicon.png" alt="MAHABUB Logo">
      </div>
      <div  class="text-center">
      <span style="font-size: 30px; margin: 10px;"><b>PREPAID BILLING</b></span>
	  <span style="font-size: 20px; margin: 10px;"><br>WiFi INTERNET VOUCHER SYSTEM</br></span>
      </div>
      <center>
	  ...
	  <span style=" width: 100%; height: 25px; font-weight: bold; font-size: 15px;">Bangladesh</span>
	   <p><b><a href="#" style="color:green;";>Whatsapp:</a></b> <b><a href="#" style="color:green;";>+8801740930198</a></b></p>
      </center>
    </div>
  </div>
</div>

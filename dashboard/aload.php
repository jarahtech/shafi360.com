            ...
            <div id="r_2" class="card">
              <div class="card-header"><h3><i class="fa fa-wifi"></i> Hotspot</h3></div>
                <div class="card-body">
                  <div class="row">
                    <div class="col-3 col-box-6">
                      <div class="box bg-blue bmh-60">
                        <a href="./?hotspot=active&session=<?= $session; ?>">
                          <h1><div style='text-align:center'><?= $counthotspotactive; ?>
						  <br>
                    ...
                    <div class="box bg-green bmh-60">
                      <a href="./?hotspot=users&profile=all&session=<?= $session; ?>">
                            <h1><div style='text-align:center'><?= $countallusers; ?>
											<br>
                  ...
                  <div class="col-3 col-box-6">
                    <div class="box bg-yellow bmh-60">
                      <a href="./?hotspot-user=add&session=<?= $session; ?>">
                        <div>
                          <h1><div style='text-align:center'><i class="fa fa-user-plus"></i>
						  <br>
                              <span style="font-size: 20px;"><?= $_add ?></span>
                          </h1>
                        </div>
                        <div>
                    ...
                    <div class="box bg-red bmh-60">
                      <a href="./?hotspot-user=generate&session=<?= $session; ?>">
                        <div>
                          <h1><div style='text-align:center'><i class="fa fa-user-plus"></i>
						  <br>
                              <span style="font-size: 20px;"><?= $_generate ?></span>
                          </h1>
                        </div>
                        <div>
                            <i class="fa fa-user-plus"></i> <?= $_hotspot_users ?>

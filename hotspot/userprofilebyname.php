<?php
/*
 *  Copyright (C) 2020-2021 Md Mahabubur Rahman (Mahabub360).
 *
...
if (!isset($_SESSION["mahabub"])) {
  ...
  if (isset($_POST['name'])) {
    ...
    $record = '; :local mac $"mac-address"; :local time [/system clock get time ]; /system script add name="$date-|-$time-|-$user-|-'.$price.'-|-$address-|-$mac-|-' . $validity . '-|-'.$name.'-|-$comment" owner="$month$year" source=$date comment=mahabub';
